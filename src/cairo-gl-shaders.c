...
/*
	...
	*/
	...
	_cairo_output_stream_printf (stream,
		...
		"  return vec3(x, y, 1.0);\n"
		"}\n"
		"vec3 %s_compute_abc(vec2 coord, float radius, vec2 center)\n"
		"{\n"
		"  float dx1, dy1;\n"
		"  float A, B, C;\n"
		"  float r1, r2;\n"
		...
		"  B = -2.0 * r2 * dx1 * (dx1 * coord.y + dy1 * center.x - dy1 * coord.x) - 2.0 * dy1 * dy1 * r1 * center.y;\n"
		...
		"}\n"
		"vec2 %s_compute_xy_1(vec2 coord, vec2 center, float r, vec3 ABC, float SQRTB)\n"
		"{\n"
		"  float x, y, dx, dy;\n"
		"  float t;\n"
		"  float r1, r2;\n"
		...
		"  return vec2(x, y);\n"
		"}\n"
		"vec2 %s_compute_xy_2(vec2 coord, vec2 center, float r, vec3 ABC, float SQRTB)\n"
		"{\n"
		"  float x, y, dx, dy;\n"
		"  float t;\n"
		"  float r1, r2;\n"
		...
		"  abc = %s_compute_abc(coord, %s_circle_1.z, %s_circle_1.xy);\n"
		"  sqrtb = %s_in_zone(abc);\n"
		...
		"  }\n"
		"  sqrtb = sqrt(sqrtb);\n"
		"  circle_1_near = %s_compute_xy_1(coord, %s_circle_1.xy, %s_circle_1.z, abc, sqrtb);\n"
		"  circle_1_far = %s_compute_xy_2(coord, %s_circle_1.xy, %s_circle_1.z, abc, sqrtb);\n"
		...
		"  vec2 my_opp_coord;\n"
		"  my_opp_coord.x = coord.x - 2.0 * (coord.x - %s_end.x);\n" 
		"  my_opp_coord.y = coord.y - 2.0 * (coord.y - %s_end.y);\n"
		"  //vec2 te; te.x = 75.0; te.y = 0.0; float my_dis_circle_opp = %s_distance(my_opp_coord, te);\n"
		"  float my_dis_circle_opp = %s_distance(my_opp_coord, circle_1_near);\n"
		"  if(my_dis_circle > my_dis_circle_opp)\n"
		"  {\n"
		"    if(%s_circle_1[2] != %s_circle_2[2])\n"
		"      return vec4(0.0, 0.0, 0.0, 0.0);\n"
		"    else if(%s_pad == 0)\n"
		...
		"  abc = %s_compute_abc(coord, %s_circle_2.z, center);\n"
		"  sqrtb = %s_in_zone(abc);\n"
		"  if(%s_circle_1.z != %s_circle_2.z)\n"
		"  {\n"
		"    if(sqrtb < 0.0) \n"
		...
		"  }\n"
		"  sqrtb = sqrt(sqrtb);\n"
		"  circle_2_near = %s_compute_xy_1(coord, %s_circle_2.xy, %s_circle_2.z, abc, sqrtb);\n"
		"  circle_2_far = %s_compute_xy_2(coord, %s_circle_2.xy, %s_circle_2.z, abc, sqrtb);\n"
